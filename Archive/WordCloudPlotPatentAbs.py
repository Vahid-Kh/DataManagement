...
import pandas as pd
from funcTxtAnalytics import abstrctExtrct
...
# fileName = r"ArticelAbstractThermalSwitch20102020.csv"
# fileName = r"ArticleAbstractThermostatsTemperatureSwitch2020.csv"
# fileName = r"ArticleAbstractBallValve2020 .csv"
# fileName = r"ArticleAbstractCheckValve2020.csv"
# fileName = r"PatentAbstractThermostatsTemperatureSwitch20102020.csv"
# fileName = r"PatentsAbstractBallValve20142020.csv"
# fileName = r"PatentsAbstractCheckValve20162020.csv"
...
# searchWord = 'sensor'
# searchWord = 'integrated'
# searchWord = 'intelligent'
# searchWord = 'way valve'
searchWord = "multifunctional"
# searchWord = "intelligent"
# searchWord = "Sensors"
# searchWord = "Hydrogen"
# searchWord = "Electronic"
# searchWord = "Intelligent"
# searchWord = "Sensors"
# searchWord = "Hydrogen"
# searchWord = "Magnetic"
...
col_list = ["Title", 'Publication Year', 'Publication Number', 'IPCR Classifications', 'URL']

df = pd.read_csv("Data/Raw Data/" + fileName , encoding="latin-1", usecols=col_list)
df = ff.addIPCdescription(df,9)
...
stopWords = ff.stopwords
stopWords.extend(df['IPC Description'].tolist())
# plot the WordCloud image
wordcloud = WordCloud(width=2500, height=1500, background_color='white', stopwords=stopWords,
